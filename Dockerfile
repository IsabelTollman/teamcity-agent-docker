...
# Install httpie (with SNI), awscli, docker-compose (pip install virtualenv --upgrade; pip install setuptools==18.5)
RUN pip install setuptools --upgrade --ignore-installed pyopenssl pyasn1 ndg-httpsclient httpie awscli docker-compose
