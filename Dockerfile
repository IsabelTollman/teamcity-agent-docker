...
# Install httpie (with SNI), awscli, docker-compose (pip install virtualenv --upgrade)
RUN pip install setuptools==18.5 pyopenssl pyasn1 ndg-httpsclient httpie awscli docker-compose
